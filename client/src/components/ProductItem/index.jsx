  ...
  return (
    <div>
      <div key={_id} className="bg-gray-400 p-6 rounded-lg shadow-md border-4 border-black/20 flex flex-col h-full justify-center">
        ...
        <button onClick={addToCart}   className="btn btn-primary border-2 border-white btn-block btn-squared bg-black text-white rounded-2xl max-w-[150px] min-w-[130px] mx-auto mt-5 hover:min-w-[132px] hover:bg-white hover:text-black hover:font-semibold">
          Add to cart
        </button>
      </div>
    </div>
