        ...
        <div className="flex flex-wrap justify-between items-center">
          ...
          <div className="w-full md:w-1/4 mb-6 md:mb-0">
            ...
            <div className="flex space-x-4">
              <a href="https://www.facebook.com/undergroundsportsnutruition" className="text-gray-400 hover:text-gray-200"><FontAwesomeIcon icon={faFacebookF} /></a>
              {/* <a href="#" className="text-gray-400 hover:text-gray-200"><FontAwesomeIcon icon={faTwitter} /></a> */}
              <a href="https://www.instagram.com/undergroundsportsnutrition/?hl=en" className="text-gray-400 hover:text-gray-200"><FontAwesomeIcon icon={faInstagram} /></a>
